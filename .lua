...
local beamedsolutionsGUI = Instance.new("ScreenGui"); beamedsolutionsGUI.Name = "beamed.solutions"; beamedsolutionsGUI.Parent = game.CoreGui; beamedsolutionsGUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
function NotificationLibrary:Notify(TitleText, Desc, Delay)
    ...
    Notification.Parent = beamedsolutionsGUI
    ...
    Line.BackgroundColor3 = Color3.fromRGB(102,0,255)
    ...
    Warning.Image = "rbxassetid://12348904289"
...
m:Notify("beamed.solutions", "Loaded", 5);
